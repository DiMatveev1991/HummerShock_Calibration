...
{
	public partial class MyMigrationHammer : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_SamplRefAcc", x => x.Id);
					table.ForeignKey(
						name: "FK_SamplRefAcc_refAccelerometers_AccelerometerId",
			...
			migrationBuilder.CreateIndex(
				name: "IX_SamplRefAcc_AccelerometerId",
				table: "SamplRefAcc",
